...
skills.forEach((skill) => updateSkills(skill));

function updateSkills(skill) {
  let percentage = skill.querySelectorAll(".skills__percentage");
  percentage.forEach(
    (perc) =>
      (perc.style.width =
        perc.parentElement.parentElement.querySelector("span").innerText)
  );
}
...
themeButton.addEventListener("click", () => {
  ...
  // saave theme and icon that user chose
