...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"sIxP":[function(require,module,exports) {
var define;
...
var _swiperBundle = _interopRequireDefault(require("./swiper-bundle.js"));
...
}); // set scill percentage

var skills = document.querySelectorAll(".skills__list");
skills.forEach(function (skill) {
  return updateSkills(skill);
});

function updateSkills(skill) {
  var percentage = skill.querySelectorAll(".skills__percentage");
  percentage.forEach(function (perc) {
    return perc.style.width = perc.parentElement.parentElement.querySelector("span").innerText;
  });
} //ACCORDION SKILLS


var skillsContent = document.querySelectorAll(".skills__content"),
...
// import "/css/swiper-bundle.css" assert { type: "css" };
var cssModule = await import("/css/swiper-bundle.css", {
  assert: {
    type: "css"
  }
});
document.adoptedStyleSheets = [cssModule.default];
var swiperPortfolio = new _swiperBundle.default(".portfolio__container", {
  cssMode: true,
  loop: true,
  navigation: {
    nextEl: ".swiper-button-next",
...
var swiperTestimonial = new _swiperBundle.default(".testimonial__container", {
  loop: true,
  grabCursor: true,
  spaceBetween: 48,
  pagination: {
...
function scrollActive() {
  ...
  sections.forEach(function (current) {
    ...
    if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) {
      document.querySelector(".nav__menu a[href*=".concat(sectionId, "]")).classList.add("active-link");
    } else {
      document.querySelector(".nav__menu a[href*=".concat(sectionId, "]")).classList.remove("active-link");
    }
  });
}

window.addEventListener("scroll", scrollActive); // CHANGE BACKGROUND HEADER
...
window.addEventListener("scroll", scrollHeader); // SHOW SCROLL TOP
...
window.addEventListener("scroll", scrollTop); // dark light THEME

var themeButton = document.getElementById("theme-button");
var darkTheme = "dark-theme";
var iconTheme = "uil-sun"; // selected theme

var selectedTheme = localStorage.getItem("selected-theme");
var selectedIcon = localStorage.getItem("selected-icon"); // get theme
...
themeButton.addEventListener("click", function () {
  ...
  themeButton.classList.toggle(iconTheme); // saave theme and icon that user chose
...
(function (global, factory) {
  ...
  function offset() {
    if (this.length > 0) {
      ...
      var _scrollTop = el === _window ? _window.scrollY : el.scrollTop;
...
},{"./swiper-bundle.js":"sIxP"}]},{},["QvaY"], null)